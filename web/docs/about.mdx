...
プロダクトを作るために必要なバックエンドサービスをすべて提供します。すべてを利用することも、必要なサービスだけを利用できます。
...
>>>>>>> 839917352874af8f7748aad47e4982c5cbf5e2fb
        </div>
      </Link>
    </div>
  </div>
...
ホスティングされたプラットフォームを使い始めるには、[app.supabase.io](https://app.supabase.io)をご覧ください。また、Supabaseを自分でホスティングする方法を学ぶには、[self-hosting](/docs/guides/hosting/overview)のドキュメントをご覧ください。
