...
=======
Visit [app.supabase.com](https://app.supabase.com) to get started with the hosted platform or visit the [self-hosting](/docs/guides/hosting/overview) docs to learn how to host Supabase yourself.
