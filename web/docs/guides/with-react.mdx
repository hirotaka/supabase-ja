...
[Create React App](https://create-react-app.dev/docs/getting-started/)を使って、
`supabase-react`というアプリを初期化します。
...
<<<<<<< HEAD
アップロード・ウィジェットは、npmライブラリーを1つ追加して使用します。`npm install @reach/visually-hidden`または、`yarn add @reach/visually-hidden`を実行してインストールします。
=======
...
>>>>>>> 950052386ddd9aeb2c35d13bb08b5b9f5b5f5184
