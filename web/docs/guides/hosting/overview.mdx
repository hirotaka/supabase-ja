...
Supabaseのセルフホスティング版には、まだUIが含まれていません。私たちは、[UIライブラリ](https://github.com/supabase/ui)から始めて、段階的に取り組んでおり、[WIP PRをこちら](https://github.com/supabase/supabase/pull/2281)に掲載しています。[\[more context](https://github.com/supabase/supabase/discussions/1001#discussioncomment-558696)].

それまでの間、Postgresデータベースを扱うための提案をいくつかご紹介します。
