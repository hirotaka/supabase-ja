...
Supabase CLIをインストールした後は、Supabaseアカウント（サインアップは[app.supabase.io](https://app.supabase.io)）を使って[ログイン](/docs/reference/cli/supabase-login)できます。
...
このギルドでは、提供されている「Supabase Studio」のリンクを使用して、`employees`というテーブルを作成します。 
...
>>>>>>> 837de63648946ca2044a1139423d8e2a1640b17d
...
ローカルでアプリケーションを開発したので、[app.supabase.io](https://app.supabase.io)に移動して、変更をデプロイするプロジェクトを作成します。
