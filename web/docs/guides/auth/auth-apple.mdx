...
- `client id`と`client secret`キーを[Supabase プロジェクト](https://supabase.com)に追加します。
...
- Add your `client id` and `client secret` keys to your [Supabase Project](https://app.supabase.io).
- Add the login code to your [Supabase JS Client App](https://github.com/supabase/supabase-js).
>>>>>>> 5c95f12eb9cb39deb67c29cb81a0a443d01e28d8
