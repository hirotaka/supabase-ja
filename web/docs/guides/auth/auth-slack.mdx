...
- [Supabaseプロジェクト](https://supabase.com)にSlackの`API Key`と`API Secret Key`を追加
...
- Add your Slack `API Key` and `API Secret Key` to your [Supabase Project](https://app.supabase.io).
