...
また、Supabaseのアカウントも必要なので、[こちら](https://app.supabase.com/)からサインインして作成します。
...
[Supabaseダッシュボード](https://app.supabase.com/)から、`New project`をクリックします。
...
[Supabase ダッシュボード](https://app.supabase.com/)のサイドバーメニューから、`Table editor`から、`New table`の順にクリックします。
